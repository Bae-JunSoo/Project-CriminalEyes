    ...
    <script type="text/javascript">
        ...
        function doSubmit(f) {
            ...
            $.ajax({
                ...
                dataType: "JSON", // 전송 결과는 JSON으로 받기
                data: $("#f").serialize(), // form 태그 내 input 등 객체를 자동으로 전송할 형태로 변경하기
                success: function (json) { // /notice/noticeUpdate 호출이 성공 했다면..
    ...
    <div class="divTable minimalistBlack">
        <div class="divTableBody">
            ...
            <div class="divTableCell">
                ...
                <button id="btnUserId" type="botton">아이디 중복체크</button>
            </div>
        </div>
        <div class="divTableRow">
            ...
            <div class="divTableCell">
                <input typ="text" name="userName" style="width:95%" placeholder="이름"/>
            </div>
        </div>
        ...
        <div class="divTableRow">
            ...
            <div class="divTableCell">
                ...
                <input type="text" name="authNumber" style="width:30%" placeholder="메일로 받은 인증번호"/>
